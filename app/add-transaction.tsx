...
const TAGS_DESPESA = ['🛒 Supermercado', '🍔 Lazer', '🏠 Casa', '🚗 Transporte', '🏥 Saúde', '🛍️ Compras', '⚡ Contas Fixas'];
...
export default function AddTransactionModal() {
  ...
  const handleSalvar = async () => {
    ...
    const resultado = await salvarTransacaoNoFirebase({
      ...
      contaSelecionada, // 👈 Agora a tabela selecionada vai direto, seja receita ou despesa!
      tagSelecionada, isParcelado, qtdParcelas, isFixo, mesesProjecao,
      isTerceiro: tipo === 'DESPESA' ? isTerceiro : false, nomeTerceiro, dataPagamento 
    });
    setIsLoading(false);
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        {/* 👈 O SELETOR DE TABELAS AGORA FICA VISÍVEL PARA AMBOS 👉 */}
        ...
        <View style={styles.formGroup}><Text style={styles.label}>Data (Opcional)</Text><TextInput style={styles.input} placeholder="DD/MM/AAAA (Branco = Hoje)" keyboardType="numeric" maxLength={10} value={dataPagamento} onChangeText={handleDataChange} /></View>
